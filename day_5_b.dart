...
void main() async {
  int largestSeatId = 0;
  List<int> claimedSeatIds = new List<int>();

  const int MAX_ID = 848; // horrible assumption based on Day 5 part 1
  ...
  print('Seats:');
  for (int i = 0; i < MAX_ID; i++) {
    if (claimedSeatIds[i] == 0) {
      print('Seat ID $i is missing.');
    }
  }
}